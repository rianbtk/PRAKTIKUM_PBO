 ...
 */
package percobaan5_Agus_Salim_H_1941723007;
 ...
 * @author kaito
 */
public class FormKoneksi_Agus_Salim_H_1941723007 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FormKoneksi1841720019Rian
     */
    public FormKoneksi_Agus_Salim_H_1941723007() {
        initComponents();
        setmTable();
    }

    private static void openConnectionRian() {
        if (sConnection == null) {
            try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormKoneksi_Agus_Salim_H_1941723007.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormKoneksi_Agus_Salim_H_1941723007().setVisible(true);
            }
        });
    }
